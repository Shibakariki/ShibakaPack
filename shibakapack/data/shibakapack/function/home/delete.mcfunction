execute store result storage shibakapack:homes temp.slot int 1 run scoreboard players get @s homeDeleteIndex
...
function shibakapack:home/delete_name with storage shibakapack:homes temp